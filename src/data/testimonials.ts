export const testimonials = [
  ...
  {
    name: "Linh Pham",
    role: "Level 4 — Crypto Strategist",
    avatar:
  ...
  {
    name: "Ethan Miller",
    role: "Level 5 — Crypto Elite / Crypto Capital",
    avatar:
